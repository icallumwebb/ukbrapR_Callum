...
load_bgen <- function(
	...
	# For multi-allelic records (e.g., tri-allelic SNPs), plink2 --export A produces one dosage
	# column per alt allele. Unique CHR:POS:REF:ALT IDs ensure alt alleles are distinguished.
